...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.8\textwidth}
        \includegraphics[width=1in]{./images/final_test/final_maze_build.jpeg}
    \end{minipage}
...
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.8\textwidth}
        \includegraphics[width=1in]{./images/thesis/web_app.png}
    \end{minipage}
...
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.8\textwidth}
        \includegraphics[width=1in]{./images/thesis/model_architecture.png}
    \end{minipage}
...
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.8\textwidth}
        \includegraphics[width=1in]{./images/final_test/jp_final.jpeg}
    \end{minipage}
...
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.8\textwidth}
        \includegraphics[width=1in]{./images/schematics/esp_updated.png}
    \end{minipage}
